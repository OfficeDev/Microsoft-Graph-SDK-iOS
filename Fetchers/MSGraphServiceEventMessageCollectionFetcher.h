...
#ifndef MSGRAPHSERVICEEVENTMESSAGECOLLECTIONFETCHER_H
#define MSGRAPHSERVICEEVENTMESSAGECOLLECTIONFETCHER_H
...
/** MSGraphServiceEventMessageCollectionFetcher
 *
 */
...
- (void)add:(MSGraphServiceEventMessage *)entity callback:(void (^)(MSGraphServiceEventMessage *, MSOrcError *))callback;

...
#ifndef MSGRAPHSERVICEMAILFOLDEROPERATIONS_H
#define MSGRAPHSERVICEMAILFOLDEROPERATIONS_H
...
/** MSGraphServiceMailFolderOperations
 *
 */
...
@interface MSGraphServiceMailFolderOperations : MSGraphServiceEntityOperations

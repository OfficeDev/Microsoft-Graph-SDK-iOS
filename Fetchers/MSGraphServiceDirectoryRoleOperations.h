...
#ifndef MSGRAPHSERVICEDIRECTORYROLEOPERATIONS_H
#define MSGRAPHSERVICEDIRECTORYROLEOPERATIONS_H
...
/** MSGraphServiceDirectoryRoleOperations
 *
 */
...
@interface MSGraphServiceDirectoryRoleOperations : MSGraphServiceDirectoryObjectOperations

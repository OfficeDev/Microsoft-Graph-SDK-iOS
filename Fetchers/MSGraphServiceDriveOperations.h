...
#ifndef MSGRAPHSERVICEDRIVEOPERATIONS_H
#define MSGRAPHSERVICEDRIVEOPERATIONS_H
...
@interface MSGraphServiceDriveOperations : MSGraphServiceEntityOperations

...
#ifndef MSGRAPHSERVICEIDENTITY_H
#define MSGRAPHSERVICEIDENTITY_H
...
/** Interface MSGraphServiceIdentity
 *
 */
...
@interface MSGraphServiceIdentity : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

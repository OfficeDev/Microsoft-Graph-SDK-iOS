...
#ifndef MSGRAPHSERVICEPROVISIONEDPLAN_H
#define MSGRAPHSERVICEPROVISIONEDPLAN_H
...
/** Interface MSGraphServiceProvisionedPlan
 *
 */
...
@interface MSGraphServiceProvisionedPlan : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

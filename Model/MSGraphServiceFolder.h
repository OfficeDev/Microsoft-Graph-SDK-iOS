...
#ifndef MSGRAPHSERVICEFOLDER_H
#define MSGRAPHSERVICEFOLDER_H
...
/** Interface MSGraphServiceFolder
 *
 */
...
@interface MSGraphServiceFolder : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

...
#ifndef MSGRAPHSERVICEENTITYOPERATIONS_H
#define MSGRAPHSERVICEENTITYOPERATIONS_H
...
/** MSGraphServiceEntityOperations
 *
 */
...
@interface MSGraphServiceEntityOperations : MSOrcOperations

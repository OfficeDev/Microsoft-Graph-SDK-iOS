...
#ifndef MSGRAPHSERVICEENTITY_H
#define MSGRAPHSERVICEENTITY_H
...
/** Interface MSGraphServiceEntity
 *
 */
...
@interface MSGraphServiceEntity : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

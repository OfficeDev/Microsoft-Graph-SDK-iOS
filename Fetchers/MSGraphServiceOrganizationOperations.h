...
#ifndef MSGRAPHSERVICEORGANIZATIONOPERATIONS_H
#define MSGRAPHSERVICEORGANIZATIONOPERATIONS_H
...
/** MSGraphServiceOrganizationOperations
 *
 */
...
@interface MSGraphServiceOrganizationOperations : MSGraphServiceDirectoryObjectOperations

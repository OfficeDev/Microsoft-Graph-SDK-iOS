...
#ifndef MSGRAPHSERVICESPECIALFOLDER_H
#define MSGRAPHSERVICESPECIALFOLDER_H
...
/** Interface MSGraphServiceSpecialFolder
 *
 */
...
@interface MSGraphServiceSpecialFolder : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

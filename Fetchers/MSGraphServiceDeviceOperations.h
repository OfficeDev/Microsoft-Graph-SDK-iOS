...
#ifndef MSGRAPHSERVICEDEVICEOPERATIONS_H
#define MSGRAPHSERVICEDEVICEOPERATIONS_H
...
/** MSGraphServiceDeviceOperations
 *
 */
...
@interface MSGraphServiceDeviceOperations : MSGraphServiceDirectoryObjectOperations

...
#ifndef MSGRAPHSERVICEDIRECTORYOBJECTCOLLECTIONFETCHER_H
#define MSGRAPHSERVICEDIRECTORYOBJECTCOLLECTIONFETCHER_H
...
/** MSGraphServiceDirectoryObjectCollectionFetcher
 *
 */
...
@interface MSGraphServiceDirectoryObjectCollectionFetcher : MSOrcCollectionFetcher
...
- (void)add:(MSGraphServiceDirectoryObject *)entity callback:(void (^)(MSGraphServiceDirectoryObject *, MSOrcError *))callback;

...
#ifndef MSGRAPHSERVICEMESSAGEOPERATIONS_H
#define MSGRAPHSERVICEMESSAGEOPERATIONS_H
...
/** MSGraphServiceMessageOperations
 *
 */
...
@interface MSGraphServiceMessageOperations : MSGraphServiceOutlookItemOperations

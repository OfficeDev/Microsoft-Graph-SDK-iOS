...
#ifndef MSGRAPHSERVICECALENDAROPERATIONS_H
#define MSGRAPHSERVICECALENDAROPERATIONS_H
...
/** MSGraphServiceCalendarOperations
 *
 */
...
@interface MSGraphServiceCalendarOperations : MSGraphServiceEntityOperations

...
#ifndef MSGRAPHSERVICEPROFILEPHOTO_H
#define MSGRAPHSERVICEPROFILEPHOTO_H
...
/** Interface MSGraphServiceProfilePhoto
 *
 */
...
@interface MSGraphServiceProfilePhoto : MSGraphServiceEntity <MSOrcInteroperableWithDictionary>

...
#ifndef MSGRAPHSERVICESHARED_H
#define MSGRAPHSERVICESHARED_H
...
/** Interface MSGraphServiceShared
 *
 */
...
@interface MSGraphServiceShared : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>

...
#ifndef MSGRAPHSERVICEDIRECTORYOBJECTOPERATIONS_H
#define MSGRAPHSERVICEDIRECTORYOBJECTOPERATIONS_H
...
/** MSGraphServiceDirectoryObjectOperations
 *
 */
...
@interface MSGraphServiceDirectoryObjectOperations : MSGraphServiceEntityOperations
